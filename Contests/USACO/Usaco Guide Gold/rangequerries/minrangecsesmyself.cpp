...
template<class T> class MinSegTreeIterative{
    private:
        ...
        vector<T> tree;
    public:
        MinSegTreeIterative(int len) : len(len){
        ...
        void set(int ind, T val){
            ...
            tree[ind] = val;
            for(; ind > 1; ind /= 2){
                tree[ind / 2] = min(tree[ind], tree[ind ^ 1]); //+ 1, and + 0
            }
        }
